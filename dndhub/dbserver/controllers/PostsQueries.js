...
static SetPostCampaign(idx_campagna, contenuto, time_stamp){
    return `INSERT INTO ArrayPostItem(idx_campagna, contenuto, time_stamp) 
    VALUES('${idx_campagna}','${contenuto}', '${time_stamp}')`;
}
    ...
    static GetIdxCampagna(idx_campagna){
        return `SELECT * FROM Campagna WHERE idx_campagna='${idx_campagna}'`;
    }
}
